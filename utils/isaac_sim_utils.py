...
class CollisionCheck:
    ...
    def print_output_message(self):
        ...
        message.append(f'id: 0, category: Box, class_name: KLT_Bin_box, ')
        for number, object in enumerate(prime):
            message.append(f'id: {self.prime_tuple[object]}, category: objects, class_name: {self.prime_tuple_name[object]}, ')
